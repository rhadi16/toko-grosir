<?php 
	...
	if ($action == "insert") {
		...
		if ($result && $result1) {
			echo '<script language="javascript"> window.location.href = "../pesanan-masuk.php?desc=success-in" </script>';
		} else {
			echo '<script language="javascript"> window.location.href = "../pesanan-masuk.php?desc=failed-in" </script>';
		}
		...
		if ($result) {
			echo '<script language="javascript"> window.location.href = "../pesanan-masuk.php?desc=success-ed" </script>';
		} else {
			echo '<script language="javascript"> window.location.href = "../pesanan-masuk.php?desc=failed-ed" </script>';
		}
		...
		if ($result && $result1) {
			echo '<script language="javascript"> window.location.href = "../pesanan-masuk.php?desc=success-del" </script>';
		} else {
			echo '<script language="javascript"> window.location.href = "../pesanan-masuk.php?desc=failed-del" </script>';
		}
