...
$database="mega-tony"; //your database name
$database_user="root"; //your username for database
...
if ($_GET["logout"]==1 && isset($_SESSION["user"])) {
    ...
    $del->execute();
    setcookie("remember", "", time() - 3600); //destroy cookie
    session_unset();
